...
<body>
	...
	<%
		...
		Expert expert = (Expert) context.get("expert");
		if (null != expert) {
	%>
	...
	<div class="container">
		<div class="row">
			...
			<div class="main col-md-12">
				<h1 class="page-title margin-top-clear"><%=expert.getName()%></h1>
				<div class="row">
					<div class="col-md-4">
						<img src="<%=expert.getPic_url()%>" alt="">

						<!-- Tab panes end-->
						<hr>
						<p>
							职称：<%=expert.getProfer_title()%></p>

						<span>职务：<%=expert.getDuty()%></span>
						<div class="elements-list pull-right">
							<span>科室： <%=expert.getDepart()%></span>
						</div>
							...
							<div class="tabs-style-2">
								...
								<ul class="nav nav-tabs" role="tablist">
									<li class="active"><a href="#h2tab1" role="tab"
										data-toggle="tab"> <i class="fa fa-file-text-o pr-5"></i>专家介绍</a>
									</li>
								</ul>
								<!-- Tab panes -->
